  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto">
        ...
        {/* Mobile: one card per day, slots stacked inside. Desktop layout below is untouched. */}
        <div className="md:hidden">
          {timetable.map((day, di) => (
            <Reveal key={day.day} delayMs={di * 100}>
              <div className="mb-8 px-5 py-5 bg-[rgba(20,20,20,0.6)] border-t border-r border-b border-t-[rgba(45,122,62,0.15)] border-r-[rgba(45,122,62,0.15)] border-b-[rgba(45,122,62,0.15)] border-l-2 border-l-green">
                <h3 className="text-3xl text-offwhite mb-4">{day.day}</h3>
        ...
        {/* Desktop: side-by-side day + time + class rows, unchanged */}
