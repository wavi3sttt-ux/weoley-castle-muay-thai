  ...
  return (
    <section className="relative px-6 py-20 md:py-[120px] overflow-hidden">
      <Image
        ...
        alt=""
        fill
        className="object-cover object-[center_20%] lg:object-[center_8%] z-0"
      />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4">
        {values.map((value, i) => (
          <Reveal key={value.title} delayMs={i * 100}>
            <div
              className={`text-center p-7 px-5 lg:p-10 border-t md:border-t-0 md:border-l border-green/40 first:border-t-0 first:md:border-l-0`}
            >
